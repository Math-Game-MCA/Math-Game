...
public class MathGame extends JApplet implements ActionListener
{
	...
	public void init(){
		...
		opA = new OperationCard("+", JLabel.CENTER);
		opS = new OperationCard("-", JLabel.CENTER);
		opM = new OperationCard("*", JLabel.CENTER);
		opD = new OperationCard("/", JLabel.CENTER);
		opParen0 = new OperationCard("(", JLabel.CENTER);
		opParen1 = new OperationCard(")", JLabel.CENTER);
